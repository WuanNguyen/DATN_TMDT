...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    filtProduct();
    searchPro = filteredPro
        .where(
          (element) => element.Product_Name.toString().contains(searchValue),
        )
        .toList();
    return Scaffold(
        appBar: AppBar(
            ...
            child: Column(
              children: [
                Container(
                  ...
                  width: MediaQuery.of(context).size.width,
                  decoration:
                      BoxDecoration(color: Color.fromRGBO(201, 241, 248, 1)),
                  child: Row(
                    children: [
